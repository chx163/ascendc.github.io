...
<!-- npu="950" id8 -->
Ascend 950PR&950DT系列产品架构下，[SIMD与SIMT混合场景](../../../../SIMT-API/SIMD_SIMT_hybrid_programming_intro/SIMD_SIMT_hybrid_programming_intro.md)中，获取到的UB大小上限为216KB，非SIMD与SIMT混合场景返回值为固定值248KB。
<!-- end id8 -->
