...
<!-- npu="950" id10 -->
以下函数原型仅支持Ascend 950PR&950DT系列产品：
...
- 支持的操作数数据类型如下：
  ...
  <!-- npu="950" id12 -->
  - Ascend 950PR&950DT系列产品，支持fp4x2_e2m1_t、fp4x2_e1m2_t、hifloat8_t、fp8_e5m2_t、fp8_e4m3fn_t、bfloat16_t。
  <!-- end id12 -->
  <!-- npu="A3" id13 -->
  - Atlas A3系列产品，支持bfloat16_t。
  <!-- end id13 -->
  <!-- npu="910b" id14 -->
  - Atlas A2系列产品，支持bfloat16_t。
  <!-- end id14 -->
