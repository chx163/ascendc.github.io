...
<!-- npu="950" id13 -->
- 针对Ascend 950PR&950DT系列产品，T和U支持的数据类型为：int16_t、half、bfloat16_t、int32_t、float、complex32、int64_t、uint64_t、complex64。数据类型complex32、int64_t、uint64_t、complex64仅支持tensor前n个数据计算接口。
<!-- end id13 -->
<!-- npu="A3" id14 -->
