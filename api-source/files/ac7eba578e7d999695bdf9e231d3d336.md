    ...
    __gm__ half* fmap, __gm__ half* weight, __gm__ half* output)
{
    ...
    asc_copy_l0c2gm(
        output, output_l0, M, COUT, M, COUT, asc_store_l2_cache_mode::NORMAL_FIRST_VICTIM,
