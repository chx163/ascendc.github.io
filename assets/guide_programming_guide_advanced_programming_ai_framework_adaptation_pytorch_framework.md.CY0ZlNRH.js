...
</code></pre></div></li><li><p>编译生成算子动态库。</p></li><li><p>在Python调用脚本中，使用torch接口生成随机输入数据并分配内存，通过导入封装的自定义模块ascendc_ops，调用自定义模块ascendc_ops中的ascendc_add函数，从而在NPU上执行算子。</p></li></ol></article></div>`,1)])])}const g=a(o,[["render",r]]);export{m as __pageData,g as default};
