# Ascend C Documentation Pages

这是 Ascend C 文档的 GitHub Pages 构建仓库。文档源码来自[https://gitcode.com/cann/asc-devkit.git](https://gitcode.com/cann/asc-devkit.git)，本仓库负责定时构建和发布网页。
