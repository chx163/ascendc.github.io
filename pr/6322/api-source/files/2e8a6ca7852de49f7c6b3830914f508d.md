...
1.  创建Conv3D对象。
    ...
    **表2**  Conv3D输入输出数据类型的组合说明
    ...
    | --- | --- | --- | --- | --- |
    | half | half | half | half | <!-- npu="A3" id1 -->Atlas A3系列产品<br><!-- end id1 --><!-- npu="910b" id2 -->Atlas A2系列产品<!-- end id2 --> |
    | bfloat16_t | bfloat16_t | float | bfloat16_t | <!-- npu="A3" id3 -->Atlas A3系列产品<br><!-- end id3 --><!-- npu="910b" id4 -->Atlas A2系列产品<!-- end id4 --> |
