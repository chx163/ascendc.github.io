...
<!-- end id2 -->
  ...
  > - 同一个逻辑位置，在不同产品型号中可能对应不同的物理内存，例如逻辑位置CO2在Atlas A2系列产品中映射到Global Memory，而在Atlas训练及推理系列产品中映射到UB，详细情况请参考[逻辑位置和物理存储的映射关系](../../../general_description_and_constraints.md#section1359919519819)。
