...
<!-- npu="950" id10 -->
- 针对Ascend 950PR&950DT系列产品，T支持的数据类型为：int8_t、uint8_t、int16_t、uint16_t、half、bfloat16_t、int32_t、uint32_t、float、complex32、int64_t、uint64_t、complex64。数据类型int8_t、uint8_t、complex32、int64_t、uint64_t、complex64仅支持tensor前n个数据计算接口和整个tensor参与计算的运算符重载。
<!-- end id10 -->
<!-- npu="A3" id11 -->
- 针对Atlas A3系列产品，T支持的数据类型为：int16_t、half、int32_t、float。
<!-- end id11 -->
<!-- npu="910b" id12 -->
- 针对Atlas A2系列产品，T支持的数据类型为：int16_t、half、int32_t、float。
<!-- end id12 -->
<!-- npu="310b" id13 -->
- 针对Atlas 200I/500 A2推理产品，T支持的数据类型为：int16_t、half、int32_t、float。
<!-- end id13 -->
<!-- npu="310p" id14 -->
- 针对Atlas推理系列产品AI Core，T支持的数据类型为：int16_t、half、int32_t、float。
<!-- end id14 -->
<!-- npu="910" id15 -->
- 针对Atlas训练系列产品，T支持的数据类型为：half、int32_t、float。
<!-- end id15 -->
<!-- npu="x90" id16 -->
