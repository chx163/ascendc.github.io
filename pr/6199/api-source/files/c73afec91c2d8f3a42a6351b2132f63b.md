...
<!-- npu="950" id8 -->
针对Ascend 950PR&950DT系列产品，支持的数据为int16_t、half、bfloat16_t、int32_t、float、complex32、int64_t、uint64_t、complex64。其中complex32、int64_t、uint64_t、complex64数据类型仅支持tensor前n个数据计算接口。
<!-- end id8 -->
