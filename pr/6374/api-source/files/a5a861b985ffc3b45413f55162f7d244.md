...
<!-- npu="950" id10 -->
- 针对Ascend 950PR&950DT系列产品，T支持的数据类型为：int16_t、uint16_t、half、bfloat16_t、int32_t、uint32_t、float、complex32、int64_t、uint64_t、complex64。数据类型complex32、int64_t、uint64_t、complex64仅支持tensor前n个数据计算接口和整个tensor参与计算的运算符重载。
<!-- end id10 -->
<!-- npu="A3" id11 -->
