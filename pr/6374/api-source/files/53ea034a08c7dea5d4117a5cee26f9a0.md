...
<!-- npu="950" id8 -->
- 针对Ascend 950PR&950DT系列产品，用于存储tensor量化参数的Fixpipe Buffer大小为4KB，用于存储tensor激活参数的Fixpipe Buffer大小为2KB，两块存储空间相互独立，地址均从0开始。tensor量化参数和tensor激活参数的起始地址和占用空间不能超出对应Buffer的范围。
<!-- end id8 -->
<!-- npu="A3,910b" id9 -->
- 针对如下产品型号：
