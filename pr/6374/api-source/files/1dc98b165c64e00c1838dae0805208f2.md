...
<!-- npu="950" id8 -->
针对Ascend 950PR&950DT系列产品，支持的数据为uint8_t、int8_t、half、bfloat16_t、int16_t、float、int32_t、uint64_t、int64_t、complex32、complex64，其中int8_t、uint8_t、uint64_t、int64_t、complex32、complex64数据类型仅支持tensor前n个数据计算接口。
<!-- end id8 -->
