...
<!-- npu="950" id13 -->
- 针对Ascend 950PR&950DT系列产品，T和U支持的数据类型为：int8_t、uint8_t、int16_t、half、bfloat16_t、int32_t、float、int64_t、uint64_t。数据类型int8_t、uint8_t、int64_t、uint64_t仅支持tensor前n个数据计算接口。
<!-- end id13 -->
<!-- npu="A3" id14 -->
