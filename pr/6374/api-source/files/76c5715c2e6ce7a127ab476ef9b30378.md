...
<!-- npu="950" id8 -->
- Ascend 950PR&950DT系列产品，取值范围是0-7。
<!-- end id8 -->
<!-- npu="A3" id9 -->
- Atlas A3系列产品，取值范围是0-7。
<!-- end id9 -->
<!-- npu="910b" id10 -->
- Atlas A2系列产品，取值范围是0-7。
<!-- end id10 -->
<!-- npu="310b" id11 -->
- Atlas 200I/500 A2推理产品，取值范围是0-7。
<!-- end id11 -->
<!-- npu="310p" id12 -->
- Atlas推理系列产品AI Core，取值范围是0-7。
<!-- end id12 -->
<!-- npu="910" id13 -->
- Atlas训练系列产品，取值范围是0-3。
<!-- end id13 -->
